...
func (c *Client) Set(key string, value string, ttl int64) (interface{}, interface{}, error) {
...
func (c *Client) Get(key string) (interface{}, interface{}, error) {
...
func (c *Client) HSet(hash string, field, value interface{}) (interface{}, interface{}, error) {
...
func (c *Client) HGet(hash string, field interface{}) (interface{}, interface{}, error) {
...
func (c *Client) Delete(key string) (interface{}, interface{}, error) {
	path := fmt.Sprintf("/rows/%s", key)
